...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-ipware-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-ipware-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-ipware
# for installing globally
pixi global install python-ipware
```
...
It is possible to list all of the versions of `python-ipware` available on your platform:
...
```
pixi search python-ipware --channel conda-forge
```
